package estudo.com.appgeradorqrcodekotlin
...
class MainActivity : AppCompatActivity() {
    ...
    var btnGeradorQRCode: Button? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnGeradorQRCode!!.setOnClickListener {
    ...
    fun initComponentes() {
        ...
        btnGeradorQRCode = findViewById(R.id.btnGerarQRCode)
